...
#livePlayerSDK
pod 'ShopLive', '1.6.8'
pod 'ShopliveSDKCommon' , '1.6.8'
#shortform SDK
pod 'ShopliveShortformSDK' , '1.6.8'
pod 'ShopliveSDKCommon' , '1.6.8'
end
```
...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.6.8"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.6.8"))
//shortform
.package(url: "https://github.com/shoplive/shortform-ios", .upToNextMajor(from: "1.6.8"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.6.8"))
//editor
..package(url: "https://github.com/shoplive/shortform-editor-ios", .upToNextMajor(from: "1.6.8"))
]
```

...
#shortform SDK
pod 'ShopliveShortformSDK' , '1.8.2'
pod 'ShopliveSDKCommon' , '1.8.2'
end
```
...
//shortform
.package(url: "https://github.com/shoplive/shortform-ios", .upToNextMajor(from: "1.8.2"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.8.2"))
//editor
..package(url: "https://github.com/shoplive/shortform-editor-ios", .upToNextMajor(from: "1.8.2"))
]
```

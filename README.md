...
#livePlayerSDK
pod 'ShopLive', '1.5.11'
pod 'ShopliveSDKCommon' , '1.5.11'
#shortform SDK
pod 'ShopliveShortformSDK' , '1.5.11'
pod 'ShopliveSDKCommon' , '1.5.11'
end
```
...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.5.11"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.5.11"))
//shortform
.package(url: "https://github.com/shoplive/shortform-ios", .upToNextMajor(from: "1.5.11"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.5.11"))
]
```

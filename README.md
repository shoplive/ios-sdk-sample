...
pod 'ShopLive', '1.4.9'
#shortform SDK
pod 'ShopliveShortformSDK' , '1.4.9'
pod 'ShopliveSDKCommon' , '1.4.9'
end
```
...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.4.9"))
//shortform
.package(url: "https://github.com/shoplive/shortform-ios", .upToNextMajor(from: "1.4.9"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.4.9"))
]
```

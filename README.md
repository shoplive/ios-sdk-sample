...
#livePlayerSDK
pod 'ShopLive', '1.5.13'
pod 'ShopliveSDKCommon' , '1.5.13'
#shortform SDK
pod 'ShopliveShortformSDK' , '1.5.13'
pod 'ShopliveSDKCommon' , '1.5.13'
end
```
...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.5.13"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.5.13"))
//shortform
.package(url: "https://github.com/shoplive/shortform-ios", .upToNextMajor(from: "1.5.13"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.5.13"))
]
```

...
#livePlayerSDK
pod 'ShopLive', '1.5.15'
pod 'ShopliveSDKCommon' , '1.5.15'
#shortform SDK
pod 'ShopliveShortformSDK' , '1.5.15'
pod 'ShopliveSDKCommon' , '1.5.15'
end
```
...
dependencies: [
//player
.package(url: "https://github.com/shoplive/ios-sdk.git", .upToNextMajor(from: "1.5.15"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.5.15"))
//shortform
.package(url: "https://github.com/shoplive/shortform-ios", .upToNextMajor(from: "1.5.15"))
.package(url: "https://github.com/shoplive/common-ios", .upToNextMajor(from: "1.5.15"))
]
```
